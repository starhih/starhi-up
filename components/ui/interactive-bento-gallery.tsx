                        ...
                        <AnimatePresence mode="wait">
                            <motion.div
                                ...
                                className="relative w-full aspect-[16/9] max-w-[95%] sm:max-w-[85%] md:max-w-3xl
                                         h-auto max-h-[70vh] rounded-2xl overflow-hidden shadow-lg"
                                ...
                                onClick={onClose}
                            >
                                <MediaItem item={selectedItem} className="w-full h-full object-contain bg-gray-100/50" onClick={onClose} />
                                <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 md:p-5
                                              bg-gradient-to-t from-[#214842]/90 to-transparent">
            ...
            >
                <motion.div
                    className="relative rounded-xl bg-[#214842]/20 backdrop-blur-xl
                             border border-[#258F67]/30 shadow-lg
        ...
        <div className="w-full">
            {(title || description) && (
                <div className="mb-8 text-center">
                    {title && (
                        <motion.h1
                            className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#214842]"
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[80px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-2xl shadow-md cursor-move ${item.span}`}
                            ...
                            >
                                ...
                                />
                                <motion.div
                                    className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 md:p-5"
                                    initial={{ opacity: 0.9 }}
                                    whileHover={{ opacity: 1 }}
                                    transition={{ duration: 0.2 }}
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-3 sm:p-4 md:p-5">
                                        <div className="absolute inset-0 bg-gradient-to-t from-[#214842]/90 via-[#214842]/50 to-transparent" />
                                        <h3 className="relative text-white text-xs sm:text-sm md:text-base font-semibold line-clamp-1">
                                            {item.title}
                                        </h3>
                                        <p className="relative text-white/80 text-[10px] sm:text-xs md:text-sm mt-1 line-clamp-2">
                                            {item.desc}
                                        </p>
                                    </div>
                                </motion.div>
